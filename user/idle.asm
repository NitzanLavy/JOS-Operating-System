...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 c0 	movl   $0x8026c0,0x803000
  800040:	26 80 00 
	...
	while (1) {
		sys_yield();
  800043:	e8 15 01 00 00       	call   80015d <sys_yield>
...
libmain(int argc, char **argv)
{
  ...
  800058:	e8 e1 00 00 00       	call   80013e <sys_getenvid>
  80005d:	25 ff 03 00 00       	and    $0x3ff,%eax
  800062:	89 c2                	mov    %eax,%edx
  800064:	c1 e2 07             	shl    $0x7,%edx
  800067:	8d 84 82 00 00 c0 ee 	lea    -0x11400000(%edx,%eax,4),%eax
  ...
  800085:	e8 a9 ff ff ff       	call   800033 <umain>
	...
	// exit gracefully
	exit();
  80008a:	e8 07 00 00 00       	call   800096 <exit>
}
...
exit(void)
{
  ...
  800099:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80009c:	e8 e9 06 00 00       	call   80078a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800119:	00 
  80011a:	c7 44 24 08 cf 26 80 	movl   $0x8026cf,0x8(%esp)
  800121:	00 
  800122:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800129:	00 
  80012a:	c7 04 24 ec 26 80 00 	movl   $0x8026ec,(%esp)
  800131:	e8 30 17 00 00       	call   801866 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001ab:	00 
  8001ac:	c7 44 24 08 cf 26 80 	movl   $0x8026cf,0x8(%esp)
  8001b3:	00 
  8001b4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001bb:	00 
  8001bc:	c7 04 24 ec 26 80 00 	movl   $0x8026ec,(%esp)
  8001c3:	e8 9e 16 00 00       	call   801866 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001fe:	00 
  8001ff:	c7 44 24 08 cf 26 80 	movl   $0x8026cf,0x8(%esp)
  800206:	00 
  800207:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80020e:	00 
  80020f:	c7 04 24 ec 26 80 00 	movl   $0x8026ec,(%esp)
  800216:	e8 4b 16 00 00       	call   801866 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800251:	00 
  800252:	c7 44 24 08 cf 26 80 	movl   $0x8026cf,0x8(%esp)
  800259:	00 
  80025a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800261:	00 
  800262:	c7 04 24 ec 26 80 00 	movl   $0x8026ec,(%esp)
  800269:	e8 f8 15 00 00       	call   801866 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002a4:	00 
  8002a5:	c7 44 24 08 cf 26 80 	movl   $0x8026cf,0x8(%esp)
  8002ac:	00 
  8002ad:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002b4:	00 
  8002b5:	c7 04 24 ec 26 80 00 	movl   $0x8026ec,(%esp)
  8002bc:	e8 a5 15 00 00       	call   801866 <_panic>
...
008002c9 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002ea:	7e 28                	jle    800314 <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002ec:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002f0:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8002f7:	00 
  8002f8:	c7 44 24 08 cf 26 80 	movl   $0x8026cf,0x8(%esp)
  8002ff:	00 
  800300:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800307:	00 
  800308:	c7 04 24 ec 26 80 00 	movl   $0x8026ec,(%esp)
  80030f:	e8 52 15 00 00       	call   801866 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80033d:	7e 28                	jle    800367 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80033f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800343:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  80034a:	00 
  80034b:	c7 44 24 08 cf 26 80 	movl   $0x8026cf,0x8(%esp)
  800352:	00 
  800353:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80035a:	00 
  80035b:	c7 04 24 ec 26 80 00 	movl   $0x8026ec,(%esp)
  800362:	e8 ff 14 00 00       	call   801866 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003b2:	7e 28                	jle    8003dc <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003b4:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003b8:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  8003bf:	00 
  8003c0:	c7 44 24 08 cf 26 80 	movl   $0x8026cf,0x8(%esp)
  8003c7:	00 
  8003c8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003cf:	00 
  8003d0:	c7 04 24 ec 26 80 00 	movl   $0x8026ec,(%esp)
  8003d7:	e8 8a 14 00 00       	call   801866 <_panic>
...
sys_time_msec(void)
{
  ...
  8003ef:	b8 0e 00 00 00       	mov    $0xe,%eax
  8003f4:	89 d1                	mov    %edx,%ecx
  8003f6:	89 d3                	mov    %edx,%ebx
  8003f8:	89 d7                	mov    %edx,%edi
  8003fa:	89 d6                	mov    %edx,%esi
...
sys_set_pri(envid_t envid, int pri)
{
  ...
  800424:	7e 28                	jle    80044e <sys_set_pri+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800426:	89 44 24 10          	mov    %eax,0x10(%esp)
  80042a:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  800431:	00 
  800432:	c7 44 24 08 cf 26 80 	movl   $0x8026cf,0x8(%esp)
  800439:	00 
  80043a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800441:	00 
  800442:	c7 04 24 ec 26 80 00 	movl   $0x8026ec,(%esp)
  800449:	e8 18 14 00 00       	call   801866 <_panic>
...
sys_pkt_send(void *addr, int size)
{
  ...
  800477:	7e 28                	jle    8004a1 <sys_pkt_send+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800479:	89 44 24 10          	mov    %eax,0x10(%esp)
  80047d:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  800484:	00 
  800485:	c7 44 24 08 cf 26 80 	movl   $0x8026cf,0x8(%esp)
  80048c:	00 
  80048d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800494:	00 
  800495:	c7 04 24 ec 26 80 00 	movl   $0x8026ec,(%esp)
  80049c:	e8 c5 13 00 00       	call   801866 <_panic>
...
sys_pkt_recv(void *addr, size_t *size)
{
  ...
  8004b7:	b8 11 00 00 00       	mov    $0x11,%eax
  ...
  8004ca:	7e 28                	jle    8004f4 <sys_pkt_recv+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8004cc:	89 44 24 10          	mov    %eax,0x10(%esp)
  8004d0:	c7 44 24 0c 11 00 00 	movl   $0x11,0xc(%esp)
  8004d7:	00 
  8004d8:	c7 44 24 08 cf 26 80 	movl   $0x8026cf,0x8(%esp)
  8004df:	00 
  8004e0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8004e7:	00 
  8004e8:	c7 04 24 ec 26 80 00 	movl   $0x8026ec,(%esp)
  8004ef:	e8 72 13 00 00       	call   801866 <_panic>
...
sys_sleep(int channel)
{
  ...
  80050a:	b8 12 00 00 00       	mov    $0x12,%eax
  ...
  80051c:	7e 28                	jle    800546 <sys_sleep+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  80051e:	89 44 24 10          	mov    %eax,0x10(%esp)
  800522:	c7 44 24 0c 12 00 00 	movl   $0x12,0xc(%esp)
  800529:	00 
  80052a:	c7 44 24 08 cf 26 80 	movl   $0x8026cf,0x8(%esp)
  800531:	00 
  800532:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800539:	00 
  80053a:	c7 04 24 ec 26 80 00 	movl   $0x8026ec,(%esp)
  800541:	e8 20 13 00 00       	call   801866 <_panic>
...
0080054e <sys_get_mac_from_eeprom>:
...
sys_get_mac_from_eeprom(uint32_t* low, uint32_t* high)
{
  ...
  80055c:	b8 13 00 00 00       	mov    $0x13,%eax
  800561:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ...
  80056f:	7e 28                	jle    800599 <sys_get_mac_from_eeprom+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800571:	89 44 24 10          	mov    %eax,0x10(%esp)
  800575:	c7 44 24 0c 13 00 00 	movl   $0x13,0xc(%esp)
  80057c:	00 
  80057d:	c7 44 24 08 cf 26 80 	movl   $0x8026cf,0x8(%esp)
  800584:	00 
  800585:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80058c:	00 
  80058d:	c7 04 24 ec 26 80 00 	movl   $0x8026ec,(%esp)
  800594:	e8 cd 12 00 00       	call   801866 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80069f:	8b 04 95 78 27 80 00 	mov    0x802778(,%edx,4),%eax
  ...
  8006ba:	c7 04 24 fc 26 80 00 	movl   $0x8026fc,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800749:	e8 d5 fa ff ff       	call   800223 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800847:	e8 84 f9 ff ff       	call   8001d0 <sys_page_map>
  ...
  800882:	e8 49 f9 ff ff       	call   8001d0 <sys_page_map>
...
err:
  ...
  80089b:	e8 83 f9 ff ff       	call   800223 <sys_page_unmap>
	sys_page_unmap(0, nva);
  8008a0:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8008a4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8008ab:	e8 73 f9 ff ff       	call   800223 <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80090f:	c7 04 24 3d 27 80 00 	movl   $0x80273d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8009e7:	c7 04 24 59 27 80 00 	movl   $0x802759,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800aa0:	c7 04 24 1c 27 80 00 	movl   $0x80271c,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800d17:	c7 44 24 0c 8c 27 80 	movl   $0x80278c,0xc(%esp)
  800d1e:	00 
  800d1f:	c7 44 24 08 93 27 80 	movl   $0x802793,0x8(%esp)
  800d26:	00 
  800d27:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800d2e:	00 
  800d2f:	c7 04 24 a8 27 80 00 	movl   $0x8027a8,(%esp)
  800d36:	e8 2b 0b 00 00       	call   801866 <_panic>
	assert(r <= PGSIZE);
  800d3b:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800d40:	7e 24                	jle    800d66 <devfile_read+0x84>
  800d42:	c7 44 24 0c b3 27 80 	movl   $0x8027b3,0xc(%esp)
  800d49:	00 
  800d4a:	c7 44 24 08 93 27 80 	movl   $0x802793,0x8(%esp)
  800d51:	00 
  800d52:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800d59:	00 
  800d5a:	c7 04 24 a8 27 80 00 	movl   $0x8027a8,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800e36:	c7 44 24 04 bf 27 80 	movl   $0x8027bf,0x4(%esp)
  800e3d:	00 
...
alloc_sockfd(int sockid)
{
  ...
  800f3c:	e8 3b f2 ff ff       	call   80017c <sys_page_alloc>
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801257:	c7 44 24 0c cb 27 80 	movl   $0x8027cb,0xc(%esp)
  80125e:	00 
  80125f:	c7 44 24 08 93 27 80 	movl   $0x802793,0x8(%esp)
  801266:	00 
  801267:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  80126e:	00 
  80126f:	c7 04 24 e0 27 80 00 	movl   $0x8027e0,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  8012b5:	c7 44 24 0c ec 27 80 	movl   $0x8027ec,0xc(%esp)
  8012bc:	00 
  8012bd:	c7 44 24 08 93 27 80 	movl   $0x802793,0x8(%esp)
  8012c4:	00 
  8012c5:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  8012cc:	00 
  8012cd:	c7 04 24 e0 27 80 00 	movl   $0x8027e0,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801350:	c7 44 24 04 f8 27 80 	movl   $0x8027f8,0x4(%esp)
  801357:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  8013a0:	e8 7e ee ff ff       	call   800223 <sys_page_unmap>
  ...
  8013b8:	e8 66 ee ff ff       	call   800223 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801416:	c7 04 24 ff 27 80 00 	movl   $0x8027ff,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801454:	75 41                	jne    801497 <devpipe_write+0x6b>
			...
			sys_yield();
  801456:	e8 02 ed ff ff       	call   80015d <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8014d4:	75 31                	jne    801507 <devpipe_read+0x63>
			...
			sys_yield();
  8014d6:	e8 82 ec ff ff       	call   80015d <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801547:	e8 30 ec ff ff       	call   80017c <sys_page_alloc>
  ...
  801581:	e8 f6 eb ff ff       	call   80017c <sys_page_alloc>
  ...
  8015b0:	e8 c7 eb ff ff       	call   80017c <sys_page_alloc>
  ...
  8015e9:	e8 e2 eb ff ff       	call   8001d0 <sys_page_map>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8016d0:	c7 44 24 04 17 28 80 	movl   $0x802817,0x4(%esp)
  8016d7:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80172d:	e8 7d e9 ff ff       	call   8000af <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801757:	eb 2a                	jmp    801783 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801759:	e8 ff e9 ff ff       	call   80015d <sys_yield>
	int c;
  ...
  801760:	e8 68 e9 ff ff       	call   8000cd <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80179f:	e8 0b e9 ff ff       	call   8000af <sys_cputs>
}
  8017a4:	c9                   	leave  
  8017a5:	c3                   	ret    
...
opencons(void)
{
  ...
  801838:	e8 3f e9 ff ff       	call   80017c <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801877:	e8 c2 e8 ff ff       	call   80013e <sys_getenvid>
  ...
  801892:	c7 04 24 24 28 80 00 	movl   $0x802824,(%esp)
  ...
  8018a8:	e8 51 00 00 00       	call   8018fe <vcprintf>
	cprintf("\n");
  8018ad:	c7 04 24 10 28 80 00 	movl   $0x802810,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8018e9:	e8 c1 e7 ff ff       	call   8000af <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801952:	e8 58 e7 ff ff       	call   8000af <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801a58:	0f be 80 47 28 80 00 	movsbl 0x802847(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801c1f:	c7 44 24 08 5f 28 80 	movl   $0x80285f,0x8(%esp)
  801c26:	00 
  ...
  801c3f:	c7 44 24 08 a5 27 80 	movl   $0x8027a5,0x8(%esp)
  801c46:	00 
  ...
  801c71:	b8 58 28 80 00       	mov    $0x802858,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8022fe:	e8 8f e0 ff ff       	call   800392 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802362:	e8 08 e0 ff ff       	call   80036f <sys_ipc_try_send>
  ...
  80238b:	e8 d6 f4 ff ff       	call   801866 <_panic>
		...
		sys_yield();
  802390:	e8 c8 dd ff ff       	call   80015d <sys_yield>
	}
