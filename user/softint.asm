...
libmain(int argc, char **argv)
{
  ...
  800048:	e8 e1 00 00 00       	call   80012e <sys_getenvid>
  80004d:	25 ff 03 00 00       	and    $0x3ff,%eax
  800052:	89 c2                	mov    %eax,%edx
  800054:	c1 e2 07             	shl    $0x7,%edx
  800057:	8d 84 82 00 00 c0 ee 	lea    -0x11400000(%edx,%eax,4),%eax
...
exit(void)
{
  ...
  800089:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80008c:	e8 e9 06 00 00       	call   80077a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800109:	00 
  80010a:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  800111:	00 
  800112:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800119:	00 
  80011a:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  800121:	e8 30 17 00 00       	call   801856 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80019b:	00 
  80019c:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  8001a3:	00 
  8001a4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001ab:	00 
  8001ac:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  8001b3:	e8 9e 16 00 00       	call   801856 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ee:	00 
  8001ef:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  8001f6:	00 
  8001f7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001fe:	00 
  8001ff:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  800206:	e8 4b 16 00 00       	call   801856 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800241:	00 
  800242:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  800249:	00 
  80024a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800251:	00 
  800252:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  800259:	e8 f8 15 00 00       	call   801856 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800294:	00 
  800295:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  80029c:	00 
  80029d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a4:	00 
  8002a5:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  8002ac:	e8 a5 15 00 00       	call   801856 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002e7:	00 
  8002e8:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  8002ef:	00 
  8002f0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002f7:	00 
  8002f8:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  8002ff:	e8 52 15 00 00       	call   801856 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80033a:	00 
  80033b:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  800342:	00 
  800343:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80034a:	00 
  80034b:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  800352:	e8 ff 14 00 00       	call   801856 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003af:	00 
  8003b0:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  8003b7:	00 
  8003b8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003bf:	00 
  8003c0:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  8003c7:	e8 8a 14 00 00       	call   801856 <_panic>
...
sys_set_pri(envid_t envid, int pri)
{
  ...
  800414:	7e 28                	jle    80043e <sys_set_pri+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800416:	89 44 24 10          	mov    %eax,0x10(%esp)
  80041a:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  800421:	00 
  800422:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  800429:	00 
  80042a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800431:	00 
  800432:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  800439:	e8 18 14 00 00       	call   801856 <_panic>
...
sys_pkt_send(void *addr, int size)
{
  ...
  800454:	b8 10 00 00 00       	mov    $0x10,%eax
  ...
  800467:	7e 28                	jle    800491 <sys_pkt_send+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800469:	89 44 24 10          	mov    %eax,0x10(%esp)
  80046d:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  800474:	00 
  800475:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  80047c:	00 
  80047d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800484:	00 
  800485:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  80048c:	e8 c5 13 00 00       	call   801856 <_panic>
...
sys_pkt_recv(void *addr, size_t *size)
{
  ...
  8004ba:	7e 28                	jle    8004e4 <sys_pkt_recv+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8004bc:	89 44 24 10          	mov    %eax,0x10(%esp)
  8004c0:	c7 44 24 0c 11 00 00 	movl   $0x11,0xc(%esp)
  8004c7:	00 
  8004c8:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  8004cf:	00 
  8004d0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8004d7:	00 
  8004d8:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  8004df:	e8 72 13 00 00       	call   801856 <_panic>
...
sys_sleep(int channel)
{
  ...
  80050c:	7e 28                	jle    800536 <sys_sleep+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  80050e:	89 44 24 10          	mov    %eax,0x10(%esp)
  800512:	c7 44 24 0c 12 00 00 	movl   $0x12,0xc(%esp)
  800519:	00 
  80051a:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  800521:	00 
  800522:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800529:	00 
  80052a:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  800531:	e8 20 13 00 00       	call   801856 <_panic>
...
0080053e <sys_get_mac_from_eeprom>:
...
sys_get_mac_from_eeprom(uint32_t* low, uint32_t* high)
{
  ...
  80054c:	b8 13 00 00 00       	mov    $0x13,%eax
  ...
  80055f:	7e 28                	jle    800589 <sys_get_mac_from_eeprom+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800561:	89 44 24 10          	mov    %eax,0x10(%esp)
  800565:	c7 44 24 0c 13 00 00 	movl   $0x13,0xc(%esp)
  80056c:	00 
  80056d:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  800574:	00 
  800575:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80057c:	00 
  80057d:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  800584:	e8 cd 12 00 00       	call   801856 <_panic>
...
sys_get_mac_from_eeprom(uint32_t* low, uint32_t* high)
{
  ...
  800589:	83 c4 2c             	add    $0x2c,%esp
  80058c:	5b                   	pop    %ebx
  80058d:	5e                   	pop    %esi
  80058e:	5f                   	pop    %edi
  80058f:	5d                   	pop    %ebp
  800590:	c3                   	ret    
  800591:	66 90                	xchg   %ax,%ax
  800593:	66 90                	xchg   %ax,%ax
  800595:	66 90                	xchg   %ax,%ax
  800597:	66 90                	xchg   %ax,%ax
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800739:	e8 d5 fa ff ff       	call   800213 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800837:	e8 84 f9 ff ff       	call   8001c0 <sys_page_map>
  ...
  800872:	e8 49 f9 ff ff       	call   8001c0 <sys_page_map>
...
err:
  ...
  80088b:	e8 83 f9 ff ff       	call   800213 <sys_page_unmap>
	sys_page_unmap(0, nva);
  800890:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800894:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80089b:	e8 73 f9 ff ff       	call   800213 <sys_page_unmap>
	return r;
...
alloc_sockfd(int sockid)
{
  ...
  800f2c:	e8 3b f2 ff ff       	call   80016c <sys_page_alloc>
...
devpipe_close(struct Fd *fd)
{
  ...
  801390:	e8 7e ee ff ff       	call   800213 <sys_page_unmap>
  ...
  8013a8:	e8 66 ee ff ff       	call   800213 <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801444:	75 41                	jne    801487 <devpipe_write+0x6b>
			...
			sys_yield();
  801446:	e8 02 ed ff ff       	call   80014d <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8014c4:	75 31                	jne    8014f7 <devpipe_read+0x63>
			...
			sys_yield();
  8014c6:	e8 82 ec ff ff       	call   80014d <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801537:	e8 30 ec ff ff       	call   80016c <sys_page_alloc>
  ...
  801571:	e8 f6 eb ff ff       	call   80016c <sys_page_alloc>
  ...
  8015a0:	e8 c7 eb ff ff       	call   80016c <sys_page_alloc>
  ...
  8015d9:	e8 e2 eb ff ff       	call   8001c0 <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80171d:	e8 7d e9 ff ff       	call   80009f <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801747:	eb 2a                	jmp    801773 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801749:	e8 ff e9 ff ff       	call   80014d <sys_yield>
	int c;
  ...
  801750:	e8 68 e9 ff ff       	call   8000bd <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80178f:	e8 0b e9 ff ff       	call   80009f <sys_cputs>
}
  801794:	c9                   	leave  
  801795:	c3                   	ret    
...
opencons(void)
{
  ...
  801828:	e8 3f e9 ff ff       	call   80016c <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801867:	e8 c2 e8 ff ff       	call   80012e <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8018d9:	e8 c1 e7 ff ff       	call   80009f <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801942:	e8 58 e7 ff ff       	call   80009f <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8022ee:	e8 8f e0 ff ff       	call   800382 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802352:	e8 08 e0 ff ff       	call   80035f <sys_ipc_try_send>
  ...
  80237b:	e8 d6 f4 ff ff       	call   801856 <_panic>
		...
		sys_yield();
  802380:	e8 c8 dd ff ff       	call   80014d <sys_yield>
	}
