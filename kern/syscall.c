...
// Set the priority field of given envid to the value given by pri.
// Priority should be between 1-100, while 1 means highest priority.
// Note: envid must be an envid of curenv or the curenv's immediate child 
//
// Returns 0 on success, < 0 on error.
// Errors are:
//	-E_BAD_ENV if given envid is not an envid of curenv's or an immediate child of curenv.
