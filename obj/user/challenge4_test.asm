...
obj/user/challenge4_test.debug:     file format elf32-i386
...
umain(int argc, char **argv)
{
  ...
  800048:	e8 b8 0b 00 00       	call   800c05 <sys_getenvid>
  80004d:	89 c6                	mov    %eax,%esi
	sys_set_pri(parent, 1);
  80004f:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
  800056:	00 
  800057:	89 04 24             	mov    %eax,(%esp)
  80005a:	e8 6b 0e 00 00       	call   800eca <sys_set_pri>

	// Fork several environments
	for (i = 0; i < 50; i++) {
  80005f:	bb 00 00 00 00       	mov    $0x0,%ebx
		envid_t id  = fork();
  800064:	e8 31 11 00 00       	call   80119a <fork>
  800069:	89 c2                	mov    %eax,%edx
		if (id == 0) {
  80006b:	85 c0                	test   %eax,%eax
  80006d:	74 19                	je     800088 <umain+0x48>
  80006f:	8d 43 03             	lea    0x3(%ebx),%eax
			break;
		} else {
			sys_set_pri(id, i+3);
  800072:	89 44 24 04          	mov    %eax,0x4(%esp)
  800076:	89 14 24             	mov    %edx,(%esp)
  800079:	e8 4c 0e 00 00       	call   800eca <sys_set_pri>
	int seen;
	envid_t parent = sys_getenvid();
	sys_set_pri(parent, 1);
	...
	// Fork several environments
	for (i = 0; i < 50; i++) {
  80007e:	83 c3 01             	add    $0x1,%ebx
  800081:	83 fb 32             	cmp    $0x32,%ebx
  800084:	75 de                	jne    800064 <umain+0x24>
  800086:	eb 19                	jmp    8000a1 <umain+0x61>
		} else {
			sys_set_pri(id, i+3);
		}
	}
	...
	if (i == 50) {
  800088:	83 fb 32             	cmp    $0x32,%ebx
  80008b:	74 14                	je     8000a1 <umain+0x61>
		sys_yield();
		return;
	}
  ...
  80008d:	81 e6 ff 03 00 00    	and    $0x3ff,%esi
  800093:	89 f0                	mov    %esi,%eax
  800095:	c1 e0 07             	shl    $0x7,%eax
  800098:	8d 94 b0 04 00 c0 ee 	lea    -0x113ffffc(%eax,%esi,4),%edx
  80009f:	eb 15                	jmp    8000b6 <umain+0x76>
			sys_set_pri(id, i+3);
		}
	}
	...
	if (i == 50) {
		cprintf("IM PARENT\n");
  8000a1:	c7 04 24 00 2c 80 00 	movl   $0x802c00,(%esp)
  8000a8:	e8 53 01 00 00       	call   800200 <cprintf>
		sys_yield();
  8000ad:	e8 72 0b 00 00       	call   800c24 <sys_yield>
		return;
  8000b2:	eb 3d                	jmp    8000f1 <umain+0xb1>
	}
  ...
  8000b4:	f3 90                	pause  
	...
	// Wait for the parent to finish forking
	while (envs[ENVX(parent)].env_status != ENV_FREE)
  8000b6:	8b 42 50             	mov    0x50(%edx),%eax
  8000b9:	85 c0                	test   %eax,%eax
  8000bb:	75 f7                	jne    8000b4 <umain+0x74>
		asm volatile("pause");


	envid_t envid = sys_getenvid();
  8000bd:	8d 76 00             	lea    0x0(%esi),%esi
  8000c0:	e8 40 0b 00 00       	call   800c05 <sys_getenvid>
	cprintf("IM SON NUMBER %d\n",(envs[ENVX(envid)].pri)-2);
  8000c5:	25 ff 03 00 00       	and    $0x3ff,%eax
  8000ca:	89 c2                	mov    %eax,%edx
  8000cc:	c1 e2 07             	shl    $0x7,%edx
  8000cf:	8d 84 82 0c 00 c0 ee 	lea    -0x113ffff4(%edx,%eax,4),%eax
  8000d6:	8b 40 70             	mov    0x70(%eax),%eax
  8000d9:	83 e8 02             	sub    $0x2,%eax
  8000dc:	89 44 24 04          	mov    %eax,0x4(%esp)
  8000e0:	c7 04 24 0b 2c 80 00 	movl   $0x802c0b,(%esp)
  8000e7:	e8 14 01 00 00       	call   800200 <cprintf>
	sys_yield();
  8000ec:	e8 33 0b 00 00       	call   800c24 <sys_yield>
...
libmain(int argc, char **argv)
{
  ...
  800106:	e8 fa 0a 00 00       	call   800c05 <sys_getenvid>
  80010b:	25 ff 03 00 00       	and    $0x3ff,%eax
  800110:	89 c2                	mov    %eax,%edx
  800112:	c1 e2 07             	shl    $0x7,%edx
  800115:	8d 84 82 00 00 c0 ee 	lea    -0x11400000(%edx,%eax,4),%eax
  80011c:	a3 0c 50 80 00       	mov    %eax,0x80500c
  ...
  800133:	e8 08 ff ff ff       	call   800040 <umain>
...
exit(void)
{
  ...
  800147:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80014a:	e8 fb 14 00 00       	call   80164a <close_all>
	sys_env_destroy(0);
  80014f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800156:	e8 58 0a 00 00       	call   800bb3 <sys_env_destroy>
}
  80015b:	c9                   	leave  
  80015c:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  80017a:	75 19                	jne    800195 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  80017c:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  800183:	00 
  800184:	8d 43 08             	lea    0x8(%ebx),%eax
  800187:	89 04 24             	mov    %eax,(%esp)
  80018a:	e8 e7 09 00 00       	call   800b76 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8001d4:	c7 04 24 5d 01 80 00 	movl   $0x80015d,(%esp)
  8001db:	e8 ae 01 00 00       	call   80038e <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  8001f3:	e8 7e 09 00 00       	call   800b76 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002f8:	0f be 80 27 2c 80 00 	movsbl 0x802c27(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004bf:	c7 44 24 08 3f 2c 80 	movl   $0x802c3f,0x8(%esp)
  8004c6:	00 
  ...
  800511:	b8 38 2c 80 00       	mov    $0x802c38,%eax
...
sys_exofork(void)
{
  ...
  801201:	a3 0c 50 80 00       	mov    %eax,0x80500c
		return env_id;
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80156a:	a1 0c 50 80 00       	mov    0x80500c,%eax
  ...
  801581:	e8 7a ec ff ff       	call   800200 <cprintf>
	*dev = 0;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8017bf:	a1 0c 50 80 00       	mov    0x80500c,%eax
  ...
  8017d6:	e8 25 ea ff ff       	call   800200 <cprintf>
		return -E_INVAL;
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801897:	a1 0c 50 80 00       	mov    0x80500c,%eax
  ...
  8018ae:	e8 4d e9 ff ff       	call   800200 <cprintf>
		return -E_INVAL;
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80194e:	75 23                	jne    801973 <ftruncate+0x63>
		cprintf("[%08x] ftruncate %d -- bad mode\n",
			thisenv->env_id, fdnum);
  801950:	a1 0c 50 80 00       	mov    0x80500c,%eax
	struct Fd *fd;
	if ((r = fd_lookup(fdnum, &fd)) < 0
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
		return r;
  ...
  801967:	e8 94 e8 ff ff       	call   800200 <cprintf>
			thisenv->env_id, fdnum);
		return -E_INVAL;
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  80228e:	89 55 e4             	mov    %edx,-0x1c(%ebp)
	...
	while (1) {
		n = thisenv->env_runs;
  802291:	a1 0c 50 80 00       	mov    0x80500c,%eax
  ...
  8022b3:	0f b6 c2             	movzbl %dl,%eax
		nn = thisenv->env_runs;
  8022b6:	8b 0d 0c 50 80 00    	mov    0x80500c,%ecx
  ...
  8022dd:	e8 1e df ff ff       	call   800200 <cprintf>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  802759:	e8 a2 da ff ff       	call   800200 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80275e:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  802762:	8b 45 10             	mov    0x10(%ebp),%eax
  802765:	89 04 24             	mov    %eax,(%esp)
  802768:	e8 32 da ff ff       	call   80019f <vcprintf>
	cprintf("\n");
  80276d:	c7 04 24 09 2c 80 00 	movl   $0x802c09,(%esp)
  802774:	e8 87 da ff ff       	call   800200 <cprintf>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80285d:	a1 0c 50 80 00       	mov    0x80500c,%eax
  ...
  80286b:	a1 0c 50 80 00       	mov    0x80500c,%eax
  802870:	8b 40 78             	mov    0x78(%eax),%eax
  802873:	89 03                	mov    %eax,(%ebx)
		return thisenv->env_ipc_value;
  802875:	a1 0c 50 80 00       	mov    0x80500c,%eax
