...
libmain(int argc, char **argv)
{
  ...
  80004c:	e8 e1 00 00 00       	call   800132 <sys_getenvid>
  800051:	25 ff 03 00 00       	and    $0x3ff,%eax
  800056:	89 c2                	mov    %eax,%edx
  800058:	c1 e2 07             	shl    $0x7,%edx
  80005b:	8d 84 82 00 00 c0 ee 	lea    -0x11400000(%edx,%eax,4),%eax
...
exit(void)
{
  ...
  80008d:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800090:	e8 e5 06 00 00       	call   80077a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  80010d:	00 
  80010e:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  800115:	00 
  800116:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80011d:	00 
  80011e:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  800125:	e8 2c 17 00 00       	call   801856 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80019f:	00 
  8001a0:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  8001a7:	00 
  8001a8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001af:	00 
  8001b0:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  8001b7:	e8 9a 16 00 00       	call   801856 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001f2:	00 
  8001f3:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  8001fa:	00 
  8001fb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800202:	00 
  800203:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  80020a:	e8 47 16 00 00       	call   801856 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800245:	00 
  800246:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  80024d:	00 
  80024e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800255:	00 
  800256:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  80025d:	e8 f4 15 00 00       	call   801856 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800298:	00 
  800299:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  8002a0:	00 
  8002a1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a8:	00 
  8002a9:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  8002b0:	e8 a1 15 00 00       	call   801856 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002eb:	00 
  8002ec:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  8002f3:	00 
  8002f4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002fb:	00 
  8002fc:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  800303:	e8 4e 15 00 00       	call   801856 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80033e:	00 
  80033f:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  800346:	00 
  800347:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80034e:	00 
  80034f:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  800356:	e8 fb 14 00 00       	call   801856 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003b3:	00 
  8003b4:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  8003bb:	00 
  8003bc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003c3:	00 
  8003c4:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  8003cb:	e8 86 14 00 00       	call   801856 <_panic>
...
sys_set_pri(envid_t envid, int pri)
{
  ...
  800418:	7e 28                	jle    800442 <sys_set_pri+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80041a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80041e:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  800425:	00 
  800426:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  80042d:	00 
  80042e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800435:	00 
  800436:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  80043d:	e8 14 14 00 00       	call   801856 <_panic>
...
sys_pkt_send(void *addr, int size)
{
  ...
  80046b:	7e 28                	jle    800495 <sys_pkt_send+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80046d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800471:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  800478:	00 
  800479:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  800480:	00 
  800481:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800488:	00 
  800489:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  800490:	e8 c1 13 00 00       	call   801856 <_panic>
...
sys_pkt_recv(void *addr, size_t *size)
{
  ...
  8004be:	7e 28                	jle    8004e8 <sys_pkt_recv+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8004c0:	89 44 24 10          	mov    %eax,0x10(%esp)
  8004c4:	c7 44 24 0c 11 00 00 	movl   $0x11,0xc(%esp)
  8004cb:	00 
  8004cc:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  8004d3:	00 
  8004d4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8004db:	00 
  8004dc:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  8004e3:	e8 6e 13 00 00       	call   801856 <_panic>
...
sys_sleep(int channel)
{
  ...
  8004fe:	b8 12 00 00 00       	mov    $0x12,%eax
  ...
  800510:	7e 28                	jle    80053a <sys_sleep+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800512:	89 44 24 10          	mov    %eax,0x10(%esp)
  800516:	c7 44 24 0c 12 00 00 	movl   $0x12,0xc(%esp)
  80051d:	00 
  80051e:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  800525:	00 
  800526:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80052d:	00 
  80052e:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  800535:	e8 1c 13 00 00       	call   801856 <_panic>
...
00800542 <sys_get_mac_from_eeprom>:
...
sys_get_mac_from_eeprom(uint32_t* low, uint32_t* high)
{
  ...
  800550:	b8 13 00 00 00       	mov    $0x13,%eax
  800555:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ...
  800563:	7e 28                	jle    80058d <sys_get_mac_from_eeprom+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800565:	89 44 24 10          	mov    %eax,0x10(%esp)
  800569:	c7 44 24 0c 13 00 00 	movl   $0x13,0xc(%esp)
  800570:	00 
  800571:	c7 44 24 08 aa 26 80 	movl   $0x8026aa,0x8(%esp)
  800578:	00 
  800579:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800580:	00 
  800581:	c7 04 24 c7 26 80 00 	movl   $0x8026c7,(%esp)
  800588:	e8 c9 12 00 00       	call   801856 <_panic>
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800739:	e8 d9 fa ff ff       	call   800217 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800837:	e8 88 f9 ff ff       	call   8001c4 <sys_page_map>
  ...
  800872:	e8 4d f9 ff ff       	call   8001c4 <sys_page_map>
...
err:
  ...
  80088b:	e8 87 f9 ff ff       	call   800217 <sys_page_unmap>
	sys_page_unmap(0, nva);
  800890:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800894:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80089b:	e8 77 f9 ff ff       	call   800217 <sys_page_unmap>
	return r;
...
alloc_sockfd(int sockid)
{
  ...
  800f2c:	e8 3f f2 ff ff       	call   800170 <sys_page_alloc>
...
devpipe_close(struct Fd *fd)
{
  ...
  801390:	e8 82 ee ff ff       	call   800217 <sys_page_unmap>
  ...
  8013a8:	e8 6a ee ff ff       	call   800217 <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801444:	75 41                	jne    801487 <devpipe_write+0x6b>
			...
			sys_yield();
  801446:	e8 06 ed ff ff       	call   800151 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8014c4:	75 31                	jne    8014f7 <devpipe_read+0x63>
			...
			sys_yield();
  8014c6:	e8 86 ec ff ff       	call   800151 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801571:	e8 fa eb ff ff       	call   800170 <sys_page_alloc>
  ...
  8015a0:	e8 cb eb ff ff       	call   800170 <sys_page_alloc>
  ...
  8015d9:	e8 e6 eb ff ff       	call   8001c4 <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80171d:	e8 81 e9 ff ff       	call   8000a3 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801747:	eb 2a                	jmp    801773 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801749:	e8 03 ea ff ff       	call   800151 <sys_yield>
	int c;
  ...
  801750:	e8 6c e9 ff ff       	call   8000c1 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80178f:	e8 0f e9 ff ff       	call   8000a3 <sys_cputs>
}
  801794:	c9                   	leave  
  801795:	c3                   	ret    
...
opencons(void)
{
  ...
  801828:	e8 43 e9 ff ff       	call   800170 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801867:	e8 c6 e8 ff ff       	call   800132 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8018d9:	e8 c5 e7 ff ff       	call   8000a3 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801942:	e8 5c e7 ff ff       	call   8000a3 <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8022ee:	e8 93 e0 ff ff       	call   800386 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802352:	e8 0c e0 ff ff       	call   800363 <sys_ipc_try_send>
  ...
  80237b:	e8 d6 f4 ff ff       	call   801856 <_panic>
		...
		sys_yield();
  802380:	e8 cc dd ff ff       	call   800151 <sys_yield>
	}
