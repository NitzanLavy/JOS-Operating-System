...
umain(int argc, char **argv)
{
  ...
  800054:	c7 04 24 c0 26 80 00 	movl   $0x8026c0,(%esp)
  80005b:	e8 0a 01 00 00       	call   80016a <cprintf>
}
  800060:	c9                   	leave  
  800061:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  800070:	e8 00 0b 00 00       	call   800b75 <sys_getenvid>
  800075:	25 ff 03 00 00       	and    $0x3ff,%eax
  80007a:	89 c2                	mov    %eax,%edx
  80007c:	c1 e2 07             	shl    $0x7,%edx
  80007f:	8d 84 82 00 00 c0 ee 	lea    -0x11400000(%edx,%eax,4),%eax
  800086:	a3 0c 40 80 00       	mov    %eax,0x80400c
  ...
  80009d:	e8 91 ff ff ff       	call   800033 <umain>
	...
	// exit gracefully
	exit();
  8000a2:	e8 07 00 00 00       	call   8000ae <exit>
}
...
exit(void)
{
  ...
  8000b1:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000b4:	e8 01 11 00 00       	call   8011ba <close_all>
	sys_env_destroy(0);
  8000b9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000c0:	e8 5e 0a 00 00       	call   800b23 <sys_env_destroy>
}
  8000c5:	c9                   	leave  
  8000c6:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000e4:	75 19                	jne    8000ff <putch+0x38>
		sys_cputs(b->buf, b->idx);
  8000e6:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  8000ed:	00 
  8000ee:	8d 43 08             	lea    0x8(%ebx),%eax
  8000f1:	89 04 24             	mov    %eax,(%esp)
  8000f4:	e8 ed 09 00 00       	call   800ae6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80013e:	c7 04 24 c7 00 80 00 	movl   $0x8000c7,(%esp)
  800145:	e8 b4 01 00 00       	call   8002fe <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80015d:	e8 84 09 00 00       	call   800ae6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800268:	0f be 80 d8 26 80 00 	movsbl 0x8026d8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80042f:	c7 44 24 08 f0 26 80 	movl   $0x8026f0,0x8(%esp)
  800436:	00 
  ...
  800481:	b8 e9 26 80 00       	mov    $0x8026e9,%eax
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8010da:	a1 0c 40 80 00       	mov    0x80400c,%eax
  ...
  8010f1:	e8 74 f0 ff ff       	call   80016a <cprintf>
	*dev = 0;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80132f:	a1 0c 40 80 00       	mov    0x80400c,%eax
  ...
  801346:	e8 1f ee ff ff       	call   80016a <cprintf>
		return -E_INVAL;
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801407:	a1 0c 40 80 00       	mov    0x80400c,%eax
  ...
  80141e:	e8 47 ed ff ff       	call   80016a <cprintf>
		return -E_INVAL;
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8014be:	75 23                	jne    8014e3 <ftruncate+0x63>
		cprintf("[%08x] ftruncate %d -- bad mode\n",
			thisenv->env_id, fdnum);
  8014c0:	a1 0c 40 80 00       	mov    0x80400c,%eax
	struct Fd *fd;
	if ((r = fd_lookup(fdnum, &fd)) < 0
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
		return r;
  ...
  8014d7:	e8 8e ec ff ff       	call   80016a <cprintf>
			thisenv->env_id, fdnum);
		return -E_INVAL;
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801dfe:	89 55 e4             	mov    %edx,-0x1c(%ebp)
	...
	while (1) {
		n = thisenv->env_runs;
  801e01:	a1 0c 40 80 00       	mov    0x80400c,%eax
  ...
  801e23:	0f b6 c2             	movzbl %dl,%eax
		nn = thisenv->env_runs;
  801e26:	8b 0d 0c 40 80 00    	mov    0x80400c,%ecx
  ...
  801e4d:	e8 18 e3 ff ff       	call   80016a <cprintf>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8022c9:	e8 9c de ff ff       	call   80016a <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8022ce:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8022d2:	8b 45 10             	mov    0x10(%ebp),%eax
  8022d5:	89 04 24             	mov    %eax,(%esp)
  8022d8:	e8 2c de ff ff       	call   800109 <vcprintf>
	cprintf("\n");
  8022dd:	c7 04 24 cc 26 80 00 	movl   $0x8026cc,(%esp)
  8022e4:	e8 81 de ff ff       	call   80016a <cprintf>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802335:	a1 0c 40 80 00       	mov    0x80400c,%eax
