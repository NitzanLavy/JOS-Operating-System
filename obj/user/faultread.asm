	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 e8 26 80 00 	movsbl 0x8026e8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80041f:	c7 44 24 08 00 27 80 	movl   $0x802700,0x8(%esp)
  800426:	00 
  ...
  800471:	b8 f9 26 80 00       	mov    $0x8026f9,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8022c8:	e8 2a de ff ff       	call   8000f7 <vcprintf>
	cprintf("\n");
  8022cd:	c7 04 24 dc 26 80 00 	movl   $0x8026dc,(%esp)
