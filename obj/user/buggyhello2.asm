...
umain(int argc, char **argv)
{
  ...
  800049:	e8 67 00 00 00       	call   8000b5 <sys_cputs>
}
  80004e:	c9                   	leave  
  80004f:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  80005e:	e8 e1 00 00 00       	call   800144 <sys_getenvid>
...
exit(void)
{
  ...
  80009f:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000a2:	e8 e3 06 00 00       	call   80078a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  80011f:	00 
  800120:	c7 44 24 08 d8 26 80 	movl   $0x8026d8,0x8(%esp)
  800127:	00 
  800128:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80012f:	00 
  800130:	c7 04 24 f5 26 80 00 	movl   $0x8026f5,(%esp)
  800137:	e8 2a 17 00 00       	call   801866 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001b1:	00 
  8001b2:	c7 44 24 08 d8 26 80 	movl   $0x8026d8,0x8(%esp)
  8001b9:	00 
  8001ba:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001c1:	00 
  8001c2:	c7 04 24 f5 26 80 00 	movl   $0x8026f5,(%esp)
  8001c9:	e8 98 16 00 00       	call   801866 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800204:	00 
  800205:	c7 44 24 08 d8 26 80 	movl   $0x8026d8,0x8(%esp)
  80020c:	00 
  80020d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800214:	00 
  800215:	c7 04 24 f5 26 80 00 	movl   $0x8026f5,(%esp)
  80021c:	e8 45 16 00 00       	call   801866 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800257:	00 
  800258:	c7 44 24 08 d8 26 80 	movl   $0x8026d8,0x8(%esp)
  80025f:	00 
  800260:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800267:	00 
  800268:	c7 04 24 f5 26 80 00 	movl   $0x8026f5,(%esp)
  80026f:	e8 f2 15 00 00       	call   801866 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002aa:	00 
  8002ab:	c7 44 24 08 d8 26 80 	movl   $0x8026d8,0x8(%esp)
  8002b2:	00 
  8002b3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002ba:	00 
  8002bb:	c7 04 24 f5 26 80 00 	movl   $0x8026f5,(%esp)
  8002c2:	e8 9f 15 00 00       	call   801866 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002fd:	00 
  8002fe:	c7 44 24 08 d8 26 80 	movl   $0x8026d8,0x8(%esp)
  800305:	00 
  800306:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80030d:	00 
  80030e:	c7 04 24 f5 26 80 00 	movl   $0x8026f5,(%esp)
  800315:	e8 4c 15 00 00       	call   801866 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800350:	00 
  800351:	c7 44 24 08 d8 26 80 	movl   $0x8026d8,0x8(%esp)
  800358:	00 
  800359:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800360:	00 
  800361:	c7 04 24 f5 26 80 00 	movl   $0x8026f5,(%esp)
  800368:	e8 f9 14 00 00       	call   801866 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003c5:	00 
  8003c6:	c7 44 24 08 d8 26 80 	movl   $0x8026d8,0x8(%esp)
  8003cd:	00 
  8003ce:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003d5:	00 
  8003d6:	c7 04 24 f5 26 80 00 	movl   $0x8026f5,(%esp)
  8003dd:	e8 84 14 00 00       	call   801866 <_panic>
...
sys_time_msec(void)
{
  ...
  8003f5:	b8 0e 00 00 00       	mov    $0xe,%eax
  8003fa:	89 d1                	mov    %edx,%ecx
  8003fc:	89 d3                	mov    %edx,%ebx
  8003fe:	89 d7                	mov    %edx,%edi
...
sys_set_pri(envid_t envid, int pri)
{
  ...
  800417:	b8 0f 00 00 00       	mov    $0xf,%eax
  ...
  80042a:	7e 28                	jle    800454 <sys_set_pri+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80042c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800430:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  800437:	00 
  800438:	c7 44 24 08 d8 26 80 	movl   $0x8026d8,0x8(%esp)
  80043f:	00 
  800440:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800447:	00 
  800448:	c7 04 24 f5 26 80 00 	movl   $0x8026f5,(%esp)
  80044f:	e8 12 14 00 00       	call   801866 <_panic>
...
sys_pkt_send(void *addr, int size)
{
  ...
  800462:	83 ec 2c             	sub    $0x2c,%esp
	...
	asm volatile("int %1\n"
  800465:	bb 00 00 00 00       	mov    $0x0,%ebx
  80046a:	b8 10 00 00 00       	mov    $0x10,%eax
  80046f:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800472:	8b 55 08             	mov    0x8(%ebp),%edx
  800475:	89 df                	mov    %ebx,%edi
  ...
  80047d:	7e 28                	jle    8004a7 <sys_pkt_send+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80047f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800483:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
  80048a:	00 
  80048b:	c7 44 24 08 d8 26 80 	movl   $0x8026d8,0x8(%esp)
  800492:	00 
  800493:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80049a:	00 
  80049b:	c7 04 24 f5 26 80 00 	movl   $0x8026f5,(%esp)
  8004a2:	e8 bf 13 00 00       	call   801866 <_panic>
...
sys_pkt_recv(void *addr, size_t *size)
{
  ...
  8004b5:	83 ec 2c             	sub    $0x2c,%esp
	...
	asm volatile("int %1\n"
  8004b8:	bb 00 00 00 00       	mov    $0x0,%ebx
  8004bd:	b8 11 00 00 00       	mov    $0x11,%eax
  ...
  8004d0:	7e 28                	jle    8004fa <sys_pkt_recv+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8004d2:	89 44 24 10          	mov    %eax,0x10(%esp)
  8004d6:	c7 44 24 0c 11 00 00 	movl   $0x11,0xc(%esp)
  8004dd:	00 
  8004de:	c7 44 24 08 d8 26 80 	movl   $0x8026d8,0x8(%esp)
  8004e5:	00 
  8004e6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8004ed:	00 
  8004ee:	c7 04 24 f5 26 80 00 	movl   $0x8026f5,(%esp)
  8004f5:	e8 6c 13 00 00       	call   801866 <_panic>
...
sys_sleep(int channel)
{
  ...
  800510:	b8 12 00 00 00       	mov    $0x12,%eax
  ...
  800522:	7e 28                	jle    80054c <sys_sleep+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800524:	89 44 24 10          	mov    %eax,0x10(%esp)
  800528:	c7 44 24 0c 12 00 00 	movl   $0x12,0xc(%esp)
  80052f:	00 
  800530:	c7 44 24 08 d8 26 80 	movl   $0x8026d8,0x8(%esp)
  800537:	00 
  800538:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80053f:	00 
  800540:	c7 04 24 f5 26 80 00 	movl   $0x8026f5,(%esp)
  800547:	e8 1a 13 00 00       	call   801866 <_panic>
...
00800554 <sys_get_mac_from_eeprom>:
...
sys_get_mac_from_eeprom(uint32_t* low, uint32_t* high)
{
  ...
  800575:	7e 28                	jle    80059f <sys_get_mac_from_eeprom+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800577:	89 44 24 10          	mov    %eax,0x10(%esp)
  80057b:	c7 44 24 0c 13 00 00 	movl   $0x13,0xc(%esp)
  800582:	00 
  800583:	c7 44 24 08 d8 26 80 	movl   $0x8026d8,0x8(%esp)
  80058a:	00 
  80058b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800592:	00 
  800593:	c7 04 24 f5 26 80 00 	movl   $0x8026f5,(%esp)
  80059a:	e8 c7 12 00 00       	call   801866 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80069f:	8b 04 95 80 27 80 00 	mov    0x802780(,%edx,4),%eax
  ...
  8006ba:	c7 04 24 04 27 80 00 	movl   $0x802704,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800749:	e8 db fa ff ff       	call   800229 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800847:	e8 8a f9 ff ff       	call   8001d6 <sys_page_map>
  ...
  800882:	e8 4f f9 ff ff       	call   8001d6 <sys_page_map>
...
err:
  ...
  80089b:	e8 89 f9 ff ff       	call   800229 <sys_page_unmap>
	sys_page_unmap(0, nva);
  8008a0:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8008a4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8008ab:	e8 79 f9 ff ff       	call   800229 <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80090f:	c7 04 24 45 27 80 00 	movl   $0x802745,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8009e7:	c7 04 24 61 27 80 00 	movl   $0x802761,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800aa0:	c7 04 24 24 27 80 00 	movl   $0x802724,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800d17:	c7 44 24 0c 94 27 80 	movl   $0x802794,0xc(%esp)
  800d1e:	00 
  800d1f:	c7 44 24 08 9b 27 80 	movl   $0x80279b,0x8(%esp)
  800d26:	00 
  800d27:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800d2e:	00 
  800d2f:	c7 04 24 b0 27 80 00 	movl   $0x8027b0,(%esp)
  800d36:	e8 2b 0b 00 00       	call   801866 <_panic>
	assert(r <= PGSIZE);
  800d3b:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800d40:	7e 24                	jle    800d66 <devfile_read+0x84>
  800d42:	c7 44 24 0c bb 27 80 	movl   $0x8027bb,0xc(%esp)
  800d49:	00 
  800d4a:	c7 44 24 08 9b 27 80 	movl   $0x80279b,0x8(%esp)
  800d51:	00 
  800d52:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800d59:	00 
  800d5a:	c7 04 24 b0 27 80 00 	movl   $0x8027b0,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800e36:	c7 44 24 04 c7 27 80 	movl   $0x8027c7,0x4(%esp)
  800e3d:	00 
...
fd2sockid(int fd)
{
  ...
  800ef5:	8b 0d 24 30 80 00    	mov    0x803024,%ecx
...
alloc_sockfd(int sockid)
{
  ...
  800f3c:	e8 41 f2 ff ff       	call   800182 <sys_page_alloc>
  ...
  800f53:	8b 15 24 30 80 00    	mov    0x803024,%edx
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801257:	c7 44 24 0c d3 27 80 	movl   $0x8027d3,0xc(%esp)
  80125e:	00 
  80125f:	c7 44 24 08 9b 27 80 	movl   $0x80279b,0x8(%esp)
  801266:	00 
  801267:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  80126e:	00 
  80126f:	c7 04 24 e8 27 80 00 	movl   $0x8027e8,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  8012b5:	c7 44 24 0c f4 27 80 	movl   $0x8027f4,0xc(%esp)
  8012bc:	00 
  8012bd:	c7 44 24 08 9b 27 80 	movl   $0x80279b,0x8(%esp)
  8012c4:	00 
  8012c5:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  8012cc:	00 
  8012cd:	c7 04 24 e8 27 80 00 	movl   $0x8027e8,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801350:	c7 44 24 04 00 28 80 	movl   $0x802800,0x4(%esp)
  801357:	00 
  ...
  801372:	00 00 00 
	stat->st_dev = &devpipe;
  801375:	c7 83 88 00 00 00 40 	movl   $0x803040,0x88(%ebx)
  80137c:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  8013a0:	e8 84 ee ff ff       	call   800229 <sys_page_unmap>
  ...
  8013b8:	e8 6c ee ff ff       	call   800229 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801416:	c7 04 24 07 28 80 00 	movl   $0x802807,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801454:	75 41                	jne    801497 <devpipe_write+0x6b>
			...
			sys_yield();
  801456:	e8 08 ed ff ff       	call   800163 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8014d4:	75 31                	jne    801507 <devpipe_read+0x63>
			...
			sys_yield();
  8014d6:	e8 88 ec ff ff       	call   800163 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801547:	e8 36 ec ff ff       	call   800182 <sys_page_alloc>
  ...
  801581:	e8 fc eb ff ff       	call   800182 <sys_page_alloc>
  ...
  8015b0:	e8 cd eb ff ff       	call   800182 <sys_page_alloc>
  ...
  8015e9:	e8 e8 eb ff ff       	call   8001d6 <sys_page_map>
  ...
  8015f4:	8b 15 40 30 80 00    	mov    0x803040,%edx
  ...
  801609:	8b 15 40 30 80 00    	mov    0x803040,%edx
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8016d0:	c7 44 24 04 1f 28 80 	movl   $0x80281f,0x4(%esp)
  8016d7:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80172d:	e8 83 e9 ff ff       	call   8000b5 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801757:	eb 2a                	jmp    801783 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801759:	e8 05 ea ff ff       	call   800163 <sys_yield>
	int c;
  ...
  801760:	e8 6e e9 ff ff       	call   8000d3 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80179f:	e8 11 e9 ff ff       	call   8000b5 <sys_cputs>
}
  8017a4:	c9                   	leave  
  8017a5:	c3                   	ret    
...
iscons(int fdnum)
{
  ...
  8017fb:	8b 15 5c 30 80 00    	mov    0x80305c,%edx
...
opencons(void)
{
  ...
  801838:	e8 45 e9 ff ff       	call   800182 <sys_page_alloc>
		return r;
  ...
  801843:	8b 15 5c 30 80 00    	mov    0x80305c,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801871:	8b 35 04 30 80 00    	mov    0x803004,%esi
  801877:	e8 c8 e8 ff ff       	call   800144 <sys_getenvid>
  ...
  801892:	c7 04 24 2c 28 80 00 	movl   $0x80282c,(%esp)
  ...
  8018a8:	e8 51 00 00 00       	call   8018fe <vcprintf>
	cprintf("\n");
  8018ad:	c7 04 24 18 28 80 00 	movl   $0x802818,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8018e9:	e8 c7 e7 ff ff       	call   8000b5 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801952:	e8 5e e7 ff ff       	call   8000b5 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801a58:	0f be 80 4f 28 80 00 	movsbl 0x80284f(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801c1f:	c7 44 24 08 67 28 80 	movl   $0x802867,0x8(%esp)
  801c26:	00 
  ...
  801c3f:	c7 44 24 08 ad 27 80 	movl   $0x8027ad,0x8(%esp)
  801c46:	00 
  ...
  801c71:	b8 60 28 80 00       	mov    $0x802860,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8022fe:	e8 95 e0 ff ff       	call   800398 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802362:	e8 0e e0 ff ff       	call   800375 <sys_ipc_try_send>
  ...
  80238b:	e8 d6 f4 ff ff       	call   801866 <_panic>
		...
		sys_yield();
  802390:	e8 ce dd ff ff       	call   800163 <sys_yield>
	}
